<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="rPresupuestos.aspx.cs" Inherits="FinanzasPersonalesWeb.Consultas.rPresupuestos" %>
    ...
    <div class="container">
        ...
        <div class="row end-row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="col-md-10 col-sm-10">
                    <asp:DropDownList ID="UsuarioDropDownList" CssClass="col-md-8 col-sm-8 dropdown" runat="server" Height="2.5em" >
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" CssClass="col-md-4 col-sm-4" runat="server" ControlToValidate="UsuarioDropDownList" ErrorMessage="Error en el Tipo de Usuario" ValidationGroup="AgregarNuevo">Porfavor elige un Usuario Valido...</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="col-md-6 col-sm-12">   
                <div class="col-md-2 col-sm-2 text-center vertical-center">
