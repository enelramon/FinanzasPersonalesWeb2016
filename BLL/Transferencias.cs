...
namespace BLL
{
    public class Transferencias : ClaseMaestra
    {
        ...
        public override bool Editar()
        {
            bool retorno = false;
            ConexionDb conexion = new ConexionDb();
            retorno = conexion.Ejecutar(String.Format("Update Transferencias set Fecha = '{0}', CuentaOrigenId = {1}, CuentaDestinoId = {2}, Monto = {3}, Observacion = '{4}', UsuarioId = {5}", this.Fecha, this.CuentaOrigenId, this.CuentaDestinoId, this.Monto, this.Observacion, this.UsuarioId));
            return retorno;
        }
